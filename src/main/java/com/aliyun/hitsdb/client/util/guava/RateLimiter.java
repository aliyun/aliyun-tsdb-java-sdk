 ...
 */
package com.aliyun.hitsdb.client.util.guava;

import com.aliyun.hitsdb.client.util.guava.base.Preconditions;
import com.aliyun.hitsdb.client.util.guava.base.Ticker;
...
/**
 * The implementation of RateLimiter is derived from the RateLimiter class of Guava 16.0,
...
public abstract class RateLimiter {
    ...
    static abstract class SleepingTicker extends Ticker {
        ...
        /**
         * sleepUninterruptibly() is copied from Uninterruptibles.sleepUninterruptibly() of Guava 16.0
         */
